        ...
        <div className="flex items-center space-x-1">
          {updateStatus.status === 'available' ? (
            ...
            <button
              ...
              title={`CloudMix Pro v${updateStatus.version || '1.6.1'} - Click to check GitHub for patches`}
            ...
            >
              ...
              <span className="inline font-bold text-cyan-300">v{updateStatus.version || '1.6.1'}</span>
