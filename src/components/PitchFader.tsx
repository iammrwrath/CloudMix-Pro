...
export const PitchFader: React.FC<PitchFaderProps> = ({
  ...
  return (
    <div className="flex flex-col items-center bg-dj-surface/90 rounded-lg p-1.5 border border-dj-border shadow-[0_4px_12px_rgba(0,0,0,0.5)] w-24">
      ...
      <div className="flex flex-col items-center mb-1">
        <span
          ...
          className="font-mono text-[12px] font-extrabold text-white cursor-pointer hover:text-cyan-400 transition-colors"
        >
      ...
      <div className="relative h-24 w-full flex items-center justify-center my-1">
        ...
        <div className="absolute left-1 inset-y-2 flex flex-col justify-between items-end pointer-events-none text-[7px] font-mono text-slate-500 font-semibold pr-1">
          <span>+</span>
          <span>+4</span>
        ...
        <div className="absolute top-1/2 left-7 right-7 h-[2px] bg-amber-400/80 shadow-[0_0_6px_rgba(251,191,36,0.8)] pointer-events-none z-10" />
        ...
        <input
          ...
          className="h-20 w-2 appearance-none bg-slate-950 rounded-full outline-none cursor-pointer -rotate-90 pitch-thumb border border-slate-800 shadow-inner"
        />
      </div>
