        ...
        <div className="flex space-x-1">
          {(['HOT CUE', 'AUTO LOOP', 'BEAT JUMP', 'STEMS'] as PadMode[]).map((mode) => (
            <button
              ...
              className={`px-1.5 sm:px-2 py-0.5 text-[9px] sm:text-[10px] font-mono font-black rounded-md tracking-wider transition-all cursor-pointer ${
                padMode === mode
          ...
          Array.from({ length: 8 }).map((_, i) => {
            ...
            return (
              <button
                ...
                className={`relative h-8 sm:h-9 md:h-10 xl:h-12 rounded-lg flex flex-col items-center justify-center font-mono font-black text-xs sm:text-[13px] transition-all cursor-pointer select-none active:scale-[0.95] ${
                  cue
          ...
          loopLengths.map((beats, i) => {
            ...
            return (
              <button
                ...
                className={`h-8 sm:h-9 md:h-10 xl:h-12 rounded-lg flex items-center justify-center space-x-1 font-mono font-black text-xs sm:text-[13px] transition-all cursor-pointer active:scale-[0.95] ${
                  isCurrentActive
        ...
        {padMode === 'BEAT JUMP' && (
          jumpDeltas.map((beats, i) => (
            <button
              ...
              className="h-8 sm:h-9 md:h-10 xl:h-12 rounded-lg flex items-center justify-center font-mono font-black text-xs sm:text-[13px] bg-slate-900/90 border border-cyan-500/40 text-cyan-300 hover:bg-slate-800 hover:border-cyan-300 active:scale-[0.95] transition-all cursor-pointer shadow-inner"
              style={{
        ...
        {padMode === 'STEMS' && (
          <>
            ...
            <button
              ...
              className={`h-8 sm:h-9 md:h-10 xl:h-12 rounded-lg flex flex-col items-center justify-center font-mono font-black text-[10.5px] transition-all cursor-pointer active:scale-[0.95] ${
                stems?.vocalsMuted
            ...
            <button
              ...
              className={`h-8 sm:h-9 md:h-10 xl:h-12 rounded-lg flex flex-col items-center justify-center font-mono font-black text-[10px] transition-all cursor-pointer active:scale-[0.95] ${
                stems?.vocalsSolo
